...
export const navbarStyles = {
  ...
  dropdownAvatar: "w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-teal-600 to-cyan-500 flex items-center justify-center text-white font-bold text-lg",
